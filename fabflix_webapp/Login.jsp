...
<body>
	...
	<div class="login">
		<center>
			...
			<div class="message">Login Customer</div><br />
			...
			<form name="Login" action="Login" method="POST">
			    ...
			    <center>
			    <a href="LoginEmployee"><button type="button" 
			style="float: center">I am an Employee</button></a>
    			    <!-- <div class="g-recaptcha" data-sitekey="6LeujSEUAAAAAALmaQR6Dv-UkFU_KK1c1LLf-Tsk"></div>  -->
			    </center>
			</form>
		</center>
